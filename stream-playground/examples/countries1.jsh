...
// 9. Prints all countries with population below 100:

countries.stream().
  filter(country -> country.getPopulation() < 100).
  forEach(System.out::println);

// 10. Prints the names of countries with population below 100:
...
// 11. Returns the sum of population of European countries:
...
// 12. Prints the population of European countries in ascending order:
...
// 13. Prints the population of European countries in descending order:
...
// 14. Returns the European country with the highest population:
...
// 15. Returns the name of the European country with the highest population:
...
// 16. Prints the names of the first five countries:
...
// 17. Returns whether there is at least one country with 0 population:

countries.stream().anyMatch(country -> country.getPopulation() == 0);

// 18. Returns whether each country has at least one timezone:
...
// 19. Returns the first country whose name starts with ‘H’:
...
// 20. Returns the number of all distinct timezones:
...
// 21. Prints all distinct timezones of European countries:
...
// 22. Prints the name and population of each country in descending order of population:
...
// 23. Returns the length of the longest country name:
...
// 24. Prints the capital of each country in ascending order of length:
...
// 25. Prints the capital of each country in ascending order of length and then in alphabetical order:
